    ...
    <div class="container">
        ...
        <section id="banner">
            <div class="wrapper">
                ...
                <div id="slide-banner">
                    <img class="slide-img" src="../content/images/banner2.jpg" alt="" />
                    <img class="slide-img" src="../content/images/banner3.png" alt="" />
                    <img class="slide-img" src="../content/images/banner4.jpg" alt="" />
                </div>
                ...
                <div class="content">
                    ...
                    foreach ($products as $product) { ?>
                        <div class="box">
                            ...
                            <a class="img-container" href="?detail=<?php echo $product['ma_hang_hoa'] ?>">
