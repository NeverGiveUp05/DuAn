...
<body style="min-height: 100vh; display: flex; flex-direction:column;">
    ...
    if (isset($user['vai_tro']) && $user['vai_tro'] == 1) { ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul class="navbar-nav" style="font-size: 15px; width: 100%">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="./loai-hang">LOẠI HÀNG</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="./hang-hoa">HÀNG HÓA</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="./khach-hang">KHÁCH HÀNG</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="./binh-luan">BÌNH LUẬN</a>
                                </li>
        ...
        <main id="main" style="padding-top: 20px; border: none;">
            <section class="container" style="padding: 0;">
                <p style="padding: 24px; text-align: center; font-size: 24px; line-height: 1.4">CÔNG CỤ QUẢN TRỊ WEBSITE</p>
            </section>
        </main>
